...
if (isset($_GET['dept'])) {
  ...
  if(isset($_POST['generatePAForm'])){
    ...
    echo "<script>window.open('PAreport.php', '_blank');</script>";
...
<div class="p-4 sm:ml-64"  id="content" style="display: none; ">
...
<div id="default-tab-content">
  ...
  <div id="paformModal" aria-hidden="true" tabindex="-1" class="bg-[#615eae59] fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
...
<input type="date" id="dateOfEffectivityPAForm" name="dateOfEffectivityPAForm" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"   />
        ...
        <button type="submit" data-modal-hide="paformModal"   name="generatePAForm" class="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                    Proceed
                </button>
